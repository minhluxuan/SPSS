...
export class CreateOrderDto{
    ...
    @IsNotEmpty()
    @IsEnum(PrintingStatus)
    printingStatus: PrintingStatus; // Status of printing
  
    @IsNotEmpty()
    @IsEnum(PurchasingStatus)
    purchasingStatus: PurchasingStatus; // Status of purchasing
    ...
    @IsNotEmpty()
    @IsUUID()
    customerId: UUID; // Customer ID who placed the order
}